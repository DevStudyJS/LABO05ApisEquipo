...
const fetchCommentsByPost = async (postId: number): Promise<void> => {
  ...
  console.log(`%c [RETO] Obteniendo comentarios del post: ${postId}...`, "color: #9b59b6; font-weight: bold;");
...
const getcursos = async (): Promise<void> => {
  ...
  const listacursos: cursos[] = data as cursos[];

  // Mostramos el resultado final en la consola del navegador
  console.log("✅ Lista de cursos recibida:");
